...
import static com.example.pipe.ubb.R.id.textViewMensaje;
import static com.example.pipe.ubb.R.id.tvMensaje;

public class mostrarJardineros extends AppCompatActivity implements View.OnClickListener{
    ...
    String  LOGIN_URL="http://34.193.208.83/jardinero/admin/eliminarJardinero.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mostrar_jardineros);
        ...
        switch (v.getId()) {
            case R.id.btnEliminar:  correo = etCorreo.getText().toString();
                                    ...
                                    if(!correo.isEmpty()&&!causa.isEmpty()){
                                        new mostrarJardineros.Eliminar().execute();
                                    }
                                    else{
                                        if(correo.isEmpty()) {
    ...
    public class Eliminar extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String file_url) {
            if(mensajePantalla.equals("El jardinero se ha eliminado correctamente")){
